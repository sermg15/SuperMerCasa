...
public class CatOfertProdController {
    ...
    public void init() {
        ...
        //Ofertas
        repositorioOferta.save(new Producto(1L, "Carne de Res", 10, "Carne de vacuno con altas propiedades proteicas", 12.99, "/images/imgCarneOFERTA.jpg"));
        ...
        //Congelados
        repositorioOferta.save(new Producto(24, "Patatas fritas", 10, "Patatas fritas para calentar al horno (1 kg)", 3.6, "/images/patatasFritas.jpg"));
        ...
        repositorioOferta.save(new Producto(26, "Alitas barbacoa", 15, "Alitas de pollo con salsa barocoa (12 piezas)", 5.5, "/images/alitasBarbacoa.jpg"));
